...
1. Tap **Analyze access evidence**.
2. Compare the recommended ridge route with the rejected river corridor.
3. Open the IOM or Nepal Red Cross source row.
4. Tap **Human approve & dispatch**.
5. Tap **Simulate new road closure** and inspect the conditional fallback.
6. Tap **Confirm responder check-in**.
...
Open one official source, return, then tap **Human approve & dispatch**.
...
Tap **Confirm responder check-in**.
...
Show the public Appetize link or QR code.
