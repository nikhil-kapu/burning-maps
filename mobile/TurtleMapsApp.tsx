...
const linking: LinkingOptions<RootParamList> = {
  prefixes: ["burningmaps://", "turtlebuddy://", ...(universalLinkOrigin && !/REPLACE|YOUR_/i.test(universalLinkOrigin) ? [universalLinkOrigin] : [])],
  config: {
    screens: {
      Tabs: {
        screens: {
...
export default function TurtleMapsApp() {
